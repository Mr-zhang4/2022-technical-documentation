<template>
	...
	<div class="boxFinding" style="width: 90%;margin:10% 0%;" v-loading="loading">
		<div style="width: 100%;" v-for="(zhoubaoWeeks,index1) in zhoubaoAll" v-bind:key="zhoubaoWeeks[0].id" ref="allPeople">

		<div>
				<div style="cursor:pointer;" v-for="(zhoubao1,index2) in zhoubaoWeeks[0]" v-bind:key="zhoubao.id">
					<el-link style="font-size: large;margin: 40% 0%;" :type="elLinkType[zhoubao.indexOf(zhoubao1)]" v-on:click="viewer(zhoubao1);changeMyType(zhoubao1)">{{zhoubao1.userName}}</el-link>
				</div>
			</div>
			<div>
