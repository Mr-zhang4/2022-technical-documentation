<template>
	<div class="block" v-loading="loading">
			<el-timeline style="width: 100%;margin: auto;">
				<div>
						...
						<el-card shadow="hover">
							...
							<el-row :gutter="5" type="flex" justify="center">
								<el-col :span="23" :offset=1>
									<div style="position: relative;top:80%;font-size: x-large;font-weight:700;">
							...
							<el-row :gutter="5" type="flex" justify="center">
								...
								<el-col :span="20">
									<div class="boxFinding">
										<div style="display:inline-block;text-align:center;cursor:pointer;" v-for="(zhoubao,index) in zhoubaoWeeks[0]" v-bind:key="zhoubao.id" v-on:click="viewer(zhoubao)">
							...
							<el-row :gutter="5" type="flex" justify="center" v-for="shuoshiYear in zhoubaoWeeks[1]" v-bind:key="shuoshiYear[0].id">
								...
								<el-col :span="40">
									<div class="boxFinding">
										...
										<div style="display:inline-block;text-align:center;cursor:pointer;" v-for="(zhoubao,userName) in shuoshiYear"
										 v-bind:key="zhoubao.id" v-on:click="viewer(zhoubao)">
                             <h3 style="color:black;">HEPS 束线线缆敷设规范</h3>
										 		<br /> <img v-bind:src="imgSrc[fileType(zhoubao.filePath)]" /><br />
