<template>
	<div class="block" v-loading="loading">
		<el-timeline style="width: 120%;margin: auto;">
						...
						<el-row :gutter="20" type="flex" justify="center">
							<el-col :span="12">
								<div style="cursor:pointer;">
									<h2 style="font-weight:800;">{{timeFormat(new Date(zhoubao.time))}}</h2>
									<h3 style="font-weight:600;"><i class="el-icon-reading"></i> {{zhoubao.filePath.localeCompare("-1") ? zhoubao.filePath.split("/").reverse()[0]:"html在线周报" }}</h3>

								</div>
							</el-col>
							<el-col :span="4">
								<div class="boxFinding">
									<img :src="imgSrc[fileType(zhoubao.filePath)] " style="margin: 4%;" />
